    ...
    <body>
        ...
        <div class="d-flex">
            <div class="card col-sm-4">
                <div class="card-body">
                    <form action="Controlador?menu=PreventaAdmin&accion=Actualizar&cod=${preventas.getIdPreventa()}" method="POST">
                        ...
                        <input type="submit" name="accion" value="Actualizar" href="Controlador?menu=PreventaAdmin" class="btn btn-success" >
                    </form>
                </div>
            </div>
            <div class="col-sm-8">
