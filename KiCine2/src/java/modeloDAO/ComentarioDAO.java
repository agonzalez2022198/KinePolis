    ...
    public List listarPeliculas(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                pel.setIdPelicula(rs.getInt(1));
                pel.setTitulo(rs.getString(2));
                pel.setGenero(rs.getString(3));
                pel.setDirector(rs.getString(4));
                pel.setDuracion(rs.getInt(5));
                pel.setSinopsis(rs.getString(6));
                pel.setAno_lanzamiento(rs.getInt(7));
                pel.setCalificacion(rs.getString(8));
                pel.setIdioma(rs.getString(9));
