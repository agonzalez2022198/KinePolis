...
public class Entrada {
    ...
    public String toString() {
        return "Entrada{" + "idEntrada=" + idEntrada + ", horarioP_id=" + horarioP_id + ", cine_id=" + cine_id + ", preventa_id=" + preventa_id + ", promocion_id=" + promocion_id + ", funcionEspecial_id=" + funcionEspecial_id + ", cantidadEntradas=" + cantidadEntradas + ", pagoTotal=" + pagoTotal + '}';
    }
