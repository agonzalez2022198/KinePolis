...
<html lang="es">
    ...
    <body>
        ...
        <table>
            <thead>
                <tr>
                    <th><span class="nombre-columna">Tipo funcion</span></th>
                    <th><span class="nombre-columna">Descripcion</span></th>
                    <th><span class="nombre-columna">Precio</span></th>
                    <th><span class="nombre-columna">Pelicula</span></th>
                    <th><span class="nombre-columna">Img</span></th>
                </tr>
            </thead>
        <c:forEach var="lista" items="${lista}">
                <tbody>
                    <tr>
                        <td><span class="nombre-columna">${lista.getTipoFuncion()}</span></td>
                        <td><span class="nombre-columna">${lista.getDescripcion()}</span></td>
                        <td><span class="nombre-columna">${lista.getPrecio()}</span></td>
                        <td><span class="nombre-columna">${lista.getTitulo()}</span></td>
                        <td><img src="ControllerIMG?id=${lista.getPelicula_id()}" style="width: 20%; height: 500%; object-fit: cover;"></td>
                    </tr>
                </tbody>
        </c:forEach>
        </table>
