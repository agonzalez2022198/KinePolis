        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><span class="nombre-columna">${lista.getDescripcion()}</span></th>
                    <th><span class="nombre-columna">${lista.getPrecioPreventa()}</span></th>
                    
                    <th><img src="ControllerIMG?id=${lista.getPelicula_id()}" style="width: 20%; height: 500%; object-fit: cover;"></th>
                    <th><a href="Controlador?menu=horariosP&accion=listar&codee=${lista.getPelicula_id()}&prev=${lista.getIdPreventa()}&pre=${lista.getPrecioPreventa()}"><button>Ver horarios</button></a></th>
                </tr>
            </thead>
        </table>
    </c:forEach>
