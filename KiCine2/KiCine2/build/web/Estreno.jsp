                    ...
                    <form action="Controlador?menu=Estreno" method="POST">
                        ...
                        <div clas="card-body">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    <label>&nbsp;&nbsp;Descripción del Estreno:</label>
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" id="txtFechaEstreno" name="txtFechaEstreno" value="${list.getFechaEstreno()}" class="form-control" placeholder="Stock">
                                </div>
                            </div>
                            <!-- AGREGAR REGISTRO-->
                            <div class="form-group">
                                <div>
                                    <input type="submit" href="Controlador?menu=Estreno&accion=Agregar" name="accion" value="Agregar" class="btn btn-success">
