    ...
    <body>
        ...
        <div class="d-flex">
            <div class="card col-sm-4">
                <div class="card-body">
                    <form action="Controlador?menu=PreventaAdmin&cod=${preventas.getIdPreventa()}" method="POST">
                        
                        <div class="form-group">
                            <label>DESCRIPCION: ${preventas.getIdPreventa()}</label>
                        ...
                        <input type="submit" name="accion" value="Agregar"  href="Controlador?menu=PreventaAdmin&accion=Agregar" class="btn btn-info">
                        <input type="submit" name="accion" value="Actualizar" href="Controlador?menu=PreventaAdmin&accion=Actualizar" class="btn btn-success" >
                    </form>
                </div>
            </div>
            <div class="col-sm-8">
