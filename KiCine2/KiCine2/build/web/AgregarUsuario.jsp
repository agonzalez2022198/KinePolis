            ...
            <div id="central">
                <div id="login">
                    ...
                    <form id="loginform" action="Controlador?menu=usuario" method="POST">
                        ...
                        <input id="correo" style="font-size: 15px;" type="text" name="correo" placeholder="correo" requ<ired>
                        <label id="txtDoble" style="font-size: 16px; color: red">${txtDoble}</label>
