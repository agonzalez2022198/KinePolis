                    ...
                    <c:forEach var="entrada" items="${entradas}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="Controlador?menu=Entrada&accion=Eliminar&id=${entrada.getIdEntrada()}" onclick="return confirm('desea eliminar este registro')">Eliminar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
