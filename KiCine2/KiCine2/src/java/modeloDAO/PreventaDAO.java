...
public class PreventaDAO {
    ...
    public List listarInnerJoin() {
        String sql = "Select pr.pelicula_id, pr.descripcion, pr.precioPreventa, p.titulo, p.foto from Preventa as pr Inner Join Pelicula as p on pr.pelicula_id = p.idPelicula";
