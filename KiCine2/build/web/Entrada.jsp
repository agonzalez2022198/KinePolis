                ...
                <tbody>
                    <c:forEach var="entrada" items="${entradas}">
                        <tr>
                            ...
                            <td>${entrada.getPromocion_id()}</td>
                            <td>${entrada.getFuncionEspecial_id()}</td>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" href="Controlador?menu=Entrada&accion=Eliminar&id=${entrada.getIdEntrada()}">Eliminar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
            ...
            <div class="card-body">
                <form action="Controlador?menu=Entrada" method="POST">
                    ...
                    <div>
                        ...
                        <input type="text" value="${entrada.getPromocion_id()}" name="txtPromocion_id" class="form-control">
                    </div>
                    <div>
                        <label>Funcion especial</label>
                        <input type="text" value="${entrada.getFuncionEspecial_id()}" name="txtFuncionEspecial_id" class="form-control">
                    </div>
                    <div>
