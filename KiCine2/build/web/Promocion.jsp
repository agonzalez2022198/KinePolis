<%-- 
    Document   : Promocion
    Created on : 21/07/2023, 11:07:12 PM
    Author     : Admin
--%>
                        ...
                        <div clas="card-body">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" name="txtNombrePromocion" value="${list.getNombre_promopcion()}" class="form-control" placeholder="Nombre Promocion">
                                </div>
                            </div>
                            <div class="form-group d-flex">
                                <div class="col-sm-6">
                            ...
                            <tbody>
                                <c:forEach var="list" items="${promocion}">
                                    <tr>
                                            ...
                                            <td>${list.getNombre_promopcion()}</td>
